...
from core.config import SOCKET_VIDEO_DIR
...
class ScreenRecorder:
    def __init__(self, output_file="screen_recorder", format_movie='mov'):
        ...
        SOCKET_VIDEO_DIR.mkdir(parents=True, exist_ok=True)
        self.output_file = str(SOCKET_VIDEO_DIR / f'{output_file}_{filename}.{format_movie}')
